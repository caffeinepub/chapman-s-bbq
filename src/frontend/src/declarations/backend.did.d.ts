...
export interface _SERVICE {
  ...
  'getAllContactsSortedByEmail' : ActorMethod<[], Array<ContactSubmission>>,
  'getAllContactsSortedByName' : ActorMethod<[], Array<ContactSubmission>>,
  'getContactById' : ActorMethod<[bigint], ContactSubmission>,
