...
export class Backend implements backendInterface {
    ...
    async getAllContactsSortedByEmail(): Promise<Array<ContactSubmission>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllContactsSortedByEmail();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllContactsSortedByName(): Promise<Array<ContactSubmission>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllContactsSortedByName();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getContactById(arg0: bigint): Promise<ContactSubmission> {
        if (this.processError) {
            try {
